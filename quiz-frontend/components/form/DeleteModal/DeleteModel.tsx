...
export default function DeleteModal(props: {pathBack:string, id:string, formAction:any, formState:any}) {
    ...
    return (
        <form action={props.formAction}>
            ...
            <div id="deleteModal" tabIndex={-1} aria-hidden="true" className="bg-slate-100/50 flex d-block overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0">
