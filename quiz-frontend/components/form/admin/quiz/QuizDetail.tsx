...
export default function QuizDetailFrom(props: {pathBack:string, formAction:any, formState:any}) {
    return (
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-[#1a2d47]">
                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <Link href={props.pathBack} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal">
                            ...
                            <span className="sr-only">Close add quiz</span>
                        </Link>
                    </div>
                    ...
                    <form className="p-4 md:p-5" action={props.formAction}>
                        <div className="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div className="col-span-2">
                                ...
                                <select id="visibility" name="visibility" defaultValue={"DEFAULT"} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
