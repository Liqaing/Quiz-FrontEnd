...
export default function QuizDetailFrom(props: {quizId:string | null, mode:string, pathBack:string, formAction:any, formState:any}) {
            ...
            <div className="relative p-4 w-full max-w-xl max-h-full">
                <div className="relative bg-white rounded-lg shadow dark:bg-[#1a2d47]">
                    ...
                    <form className="p-4 md:p-5" action={props.formAction}>
                        ...
                        <input type="text" hidden name="id" id="id" value={quizData?.id}/>

                        <div className="grid gap-4 mb-4 grid-cols-2">
                            <div className="col-span-2">
                                <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quiz Title</label>
                                <input type="text" name="name" id="name" value={quizData?.name} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter quiz title" required />
                            </div>                            
                            <div className="col-span-2">
                                <label htmlFor="visibility" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Visibility</label>
                                <select id="visibility" name="visibility" value={quizData?.visibility.toUpperCase()} defaultValue={quizData?.visibility ? quizData.visibility.toUpperCase() : "DEFAULT"} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            ...
                            <div className="col-span-2">
                                ...
                                <textarea id="description" name="description" rows={6} value={quizData?.description} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter quiz description"></textarea>                    
                            </div>
                        </div>                    
                        ...
                        <div className="flex justify-end items-center space-x-4" role="group">
                            <FormSubmit pathBack="/admin/quiz"></FormSubmit>
                        </div>
