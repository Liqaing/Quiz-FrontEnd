...
export default function QuizDetailDisplay(props: {quizId:string | null, modelHandler:any}) {
    ...
    return (
        <div tabIndex={-1} aria-hidden="true" className="bg-neutral-950/55 flex h-full overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div className="relative flex items-center lg:size-6/12 md:size-8/12 size-11/12">
                        ...
                        <div className="h-fit flex flex-col items-center justify-between p-4 md:p-5 dark:border-gray-600">
                            ...
                            <div className="w-full flex justify-end gap-3">
                                <Button 
                                    ...
                                    type="button" 
                                    className=" md:px-4 py-1.5 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                                    Cancel
                                </Button>
                                <Link href={`/home/play/${quizData?.id}`} type="submit" className="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-1.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">                                    
                                    Start
                                </Link>
                            </div>
                        </div>
