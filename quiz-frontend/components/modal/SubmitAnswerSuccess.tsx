                    ...
                    <div className="h-full flex flex-col">
                        ...
                        <div className="h-full flex flex-col gap-6 items-center justify-between p-4 md:p-5 dark:border-gray-600">
                            ...
                            <div className="w-full flex justify-end gap-3">
                                ...
                                <Link href="/home/play-history/" type="submit" className="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">                                    
                                    See result 
                                </Link>
                            </div>
                        </div>
